...
export type Plan = 'guest' | 'free' | 'basic' | 'pro' | 'unlimited'
...
export const PLAN_INFO: Record<Plan, { name: string; price: number; dailyLimit: number; badge: string }> = {
  ...
  unlimited: { name: '무제한', price: 39900, dailyLimit: -1, badge: 'Unlimited' }
}
...
export const FEATURES: Record<string, FeatureConfig> = {
  ...
  title: {
    ...
    category: 'content',
    access: { guest: 'limited', free: 'limited', basic: 'limited', pro: 'full', unlimited: 'full' },
    limits: { guest: { maxTitles: 3 }, free: { maxTitles: 3 }, basic: { maxTitles: 10 }, pro: { maxTitles: -1 }, unlimited: { maxTitles: -1 } }
  },
  blueocean: {
    name: 'blueocean',
    ...
    category: 'content',
    access: { guest: 'limited', free: 'limited', basic: 'limited', pro: 'full', unlimited: 'full' },
    limits: { guest: { maxKeywords: 5 }, free: { maxKeywords: 5 }, basic: { maxKeywords: 20 }, pro: { maxKeywords: -1 }, unlimited: { maxKeywords: -1 } }
  },
  writing: {
    name: 'writing',
    displayName: '글쓰기 가이드',
    ...
    category: 'content',
    access: { guest: 'limited', free: 'limited', basic: 'full', pro: 'full', unlimited: 'full' }
  },
  hashtag: {
    name: 'hashtag',
    displayName: '해시태그 추천',
    ...
    category: 'content',
    access: { guest: 'full', free: 'full', basic: 'full', pro: 'full', unlimited: 'full' }
  },
  timing: {
    name: 'timing',
  ...
  report: {
    ...
    category: 'analysis',
    access: { guest: 'none', free: 'none', basic: 'limited', pro: 'full', unlimited: 'full' },
    limits: { basic: { monthlyLimit: 2 }, pro: { monthlyLimit: -1 }, unlimited: { monthlyLimit: -1 } }
  },
  lowquality: {
    name: 'lowquality',
  ...
  backup: {
    ...
    category: 'analysis',
    access: { guest: 'none', free: 'none', basic: 'limited', pro: 'full', unlimited: 'full' },
    limits: { basic: { monthlyLimit: 1 }, pro: { monthlyLimit: -1 }, unlimited: { monthlyLimit: -1 } }
  },
  campaign: {
    name: 'campaign',
    displayName: '체험단 매칭',
  ...
  ranktrack: {
    ...
    category: 'analysis',
    access: { guest: 'none', free: 'none', basic: 'limited', pro: 'limited', unlimited: 'full' },
    limits: { basic: { maxKeywords: 5 }, pro: { maxKeywords: 50 }, unlimited: { maxKeywords: -1 } }
  },
  clone: {
    name: 'clone',
...
export function getFeatureAccess(featureName: string, plan: Plan): FeatureAccessInfo {
  ...
  if (accessLevel === 'none') {
    ...
    const plans: Plan[] = ['basic', 'pro', 'unlimited']
    for (const p of plans) {
...
export function getMinimumPlan(featureName: string): Plan | null {
  ...
  const plans: Plan[] = ['guest', 'free', 'basic', 'pro', 'unlimited']
