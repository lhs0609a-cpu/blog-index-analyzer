...
export const GUIDES: Guide[] = [
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    category: '블로그 지수',
    summary:
      '블랭크의 블로그 레벨은 준최1~준최7, 최적1~최적4로 이어지는 11단계 척도입니다. 이 등급은 네이버가 부여하는 값이 아니라, 관측 가능한 6개 신호(정확매칭 색인률, 통합검색 노출, 색인 지연, 주제 일관성, 콘텐츠 품질, 이웃 활동)를 종합해 산출한 상대적 위치 추정치입니다. 등급 자체보다 중요한 것은 "같은 주제의 상위 문서 대비 내 문서가 어디쯤인가"이며, 등급은 그 가능성을 요약한 값으로 읽어야 합니다.',
    keyFacts: [
