      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6">
          <div className="space-y-6 text-gray-700">
            ...
            <section>
              <h4 className="font-bold text-gray-900 mb-3 text-lg">7. 개인정보 보호책임자</h4>
              <div className="bg-gray-50 rounded-lg p-4">
                <p className="mb-2">개인정보 처리에 관한 문의사항은 아래로 연락주시기 바랍니다.</p>
                <ul className="space-y-1 text-sm">
                  <li><strong>담당자:</strong> 개인정보 보호책임자</li>
            ...
            <section>
              <h4 className="font-bold text-gray-900 mb-3 text-lg">8. 개인정보 처리방침 변경</h4>
              <p>
