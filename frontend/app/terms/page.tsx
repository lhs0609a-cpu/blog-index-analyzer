  ...
  return (
    <div className="space-y-6 text-gray-700">
      <section>
        ...
        <p>
          본 약관은 블로그 인덱스 분석기(이하 "서비스")가 제공하는 모든 서비스의 이용조건 및
          절차, 이용자와 서비스 제공자의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.
        </p>
      </section>
      ...
      <section>
        ...
        <ol className="list-decimal list-inside space-y-2">
          <li>"서비스"란 블로그 분석, 키워드 추천, AI 콘텐츠 생성 등 본 플랫폼에서 제공하는 모든 기능을 의미합니다.</li>
