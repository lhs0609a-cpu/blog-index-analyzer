...
const blocks: SeoBlock[] = [
  ...
  {
    kind: 'p',
    text: '블스피는 광고 경쟁도와 검색 노출 난이도를 분리해서 보여줍니다. 이 둘은 자주 혼동되지만 전혀 다른 값입니다. 광고 경쟁이 치열하지만 블로그 상위 노출은 쉬운 키워드가 실제로 존재하고, 그 반대도 존재합니다.',
  },
...
const faq = [
  {
    ...
    answer:
      '네이버 검색광고에서 제공하는 월간 검색수를 기준으로 합니다. PC와 모바일이 분리되어 제공되며, 블스피는 두 값을 함께 보여줍니다.',
  },
  {
