...
const homeFaq = [
  {
    ...
    answer:
      '블랭크에서 블로그 주소나 아이디만 입력하면 가입 없이 무료로 확인할 수 있습니다. 색인률·통합검색 노출·주제 일관성 등 6개 신호를 실측해 11단계(준최1~7, 최적1~4) 중 현재 위치를 추정해 보여줍니다. 다만 이 등급은 네이버가 공개하는 공식 값이 아니라, 외부에서 관측 가능한 지표로 계산한 추정치입니다.',
  },
  {
