...
SEEDS = [
    ...
    # 요리
    "레시피", "집밥반찬", "에어프라이어요리", "밀키트추천", "홈베이킹", "자취요리",
    # 문화여가 — 어군이 크다. '가볼만한곳'·'데이트코스'는 지역마다 따로 선다.
    "가볼만한곳", "데이트코스", "놀거리", "축제", "전시회", "뮤지컬", "테마파크",
    "드라이브코스", "야경명소", "박물관",
    # 패션
    "패딩추천", "운동화추천", "원피스", "백팩추천", "손목시계",
    # 자동차
    "중고차", "전기차", "자동차보험", "타이어교체", "블랙박스추천", "렌터카",
    # 운동
    "헬스장", "필라테스", "요가원", "수영장", "스크린골프", "등산코스", "홈트",
