...
POST_TEMPLATES = {
    "free": [
        ...
        {
            "titles": [
                "요즘 퇴근하면 너무 지쳐서 아무것도 못하겠어요",
                "직장인인데 퇴근 후 번아웃이 심해서 글도 못 쓰겠어요",
                "만성 피로 겪으시는 분들 어떻게 극복하시나요",
            ],
            "content": "요즘 야근이 잦아져서 퇴근하면 9시인데\n"
                       "밥 먹고 씻으면 10시, 넋 놓고 폰만 보다 잠듦\n\n"
                       "블로그도 써야 하고 운동도 하고 싶은데 체력이 안 따라줘요\n"
                       "비슷한 분들 어떻게 극복하시나요?",
            "tags": ["직장인일상", "번아웃", "체력관리"],
        },
        {
            "titles": [
                "카페에서 노트북 펴고 블로그 쓰는 사람 저뿐인가요",
                "카페 작업러들 추천 카페 공유해요",
                "집에서 글이 안 써져서 매일 카페 출근합니다",
            ],
            "content": "집에서는 유혹이 너무 많아서 카페에서 블로그 쓰고 있어요\n\n"
                       "아메리카노 한 잔에 2-3시간 앉아서 글 쓰는데\n"
                       "확실히 집보다 집중이 잘 돼요\n"
                       "음료 하나로 3시간은 좀 민폐인가 고민이에요 ㅋㅋ\n\n"
                       "카페에서 작업하시는 분들 보통 얼마나 계시나요?",
            "tags": ["카페작업", "블로그일상", "잡담"],
        },
        {
            "titles": [
                "점심 뭐 먹을지 고르는 게 하루 중 가장 어려운 일",
                "매일 점심 메뉴 고르기가 이렇게 스트레스일 줄이야",
                "다들 점심 메뉴 어떻게 정하시나요?",
            ],
            "content": "매일 동료들이랑 '뭐 먹지?' 하는데 이게 세상에서 제일 어려워요ㅋㅋ\n"
                       "회사 근처 맛집은 이미 다 돌았고\n"
                       "결국 매번 '아무거나'로 귀결되는데 다들 어떻게 정하시나요?",
            "tags": ["직장인일상", "점심메뉴", "잡담"],
        },
        {
            "titles": [
                "ChatGPT로 블로그 글 쓰는 사람 많던데 어떻게 생각하세요?",
                "AI 글쓰기 vs 직접 글쓰기 여러분의 의견은?",
                "AI로 글 쓰는 게 대세가 되는 것 같아서 고민입니다",
            ],
            "content": "요즘 ChatGPT로 하루에 5-10개씩 찍어내는 분들이 있더라고요\n\n"
                       "저도 글 하나에 2시간 걸리는데 AI 쓰면 10분이니까 흔들리긴 해요\n"
                       "근데 AI 글은 비슷비슷하고 저품질 위험도 있고\n\n"
                       "다들 AI 글쓰기에 대해 어떻게 생각하시나요?",
            "tags": ["AI글쓰기", "ChatGPT", "블로그토론"],
        },
        {
            "titles": [
                "30대 되니까 달라진 것들 공감하시나요",
                "20대 때는 몰랐던 30대의 현실",
                "나이 들면서 변한 것들 이야기해요",
            ],
            "content": "올해 32살인데 확실히 달라진 것들:\n\n"
                       "1. 밤새는 게 물리적으로 불가능\n"
                       "2. 건강 관련 검색이 늘었음\n"
                       "3. 유행 따라가기를 포기함\n"
                       "4. 주말에 쉬는 게 최고의 여가활동\n\n"
        ...
        {
            "titles": [
                "MBTI가 블로그 스타일에 영향을 주는 것 같아요",
                "MBTI별 블로그 유형이 궁금합니다",
                "I유형 블로거와 E유형 블로거의 차이점ㅋㅋ",
            ],
            "content": "저는 INFP인데 블로그 스타일이 완전 감성 일기체예요\n\n"
                       "주변 블로거들 보면 MBTI별로 스타일이 다르더라고요\n"
                       "ESTJ: 정보 정리형, ENFP: 매번 다른 스타일, INTJ: 데이터 기반\n\n"
                       "다들 MBTI랑 블로그 스타일이 어떤가요?",
            "tags": ["MBTI", "블로그스타일", "잡담"],
        },
        {
            "titles": [
                "물가 진짜 미쳤다 장보고 깜짝 놀랐어요",
                "요즘 마트 장보기가 무서운 물가 근황",
                "자취 생활비가 만만치 않은 요즘 물가",
            ],
            "content": "오늘 마트 갔다가 진짜 놀랐어요\n\n"
                       "사과 4개 12,000원, 계란 30구 9,800원\n"
                       "장바구니 10개 담았는데 7만원이라니\n\n"
                       "자취하시는 분들 식비 관리 어떻게 하시나요?\n"
                       "절약 팁 공유 부탁합니다!",
            "tags": ["물가", "자취생활", "절약팁"],
        },
    ],
...
COMMENT_TEMPLATES_BY_CATEGORY = {
    "free": [
        ...
        "응원합니다! 꾸준함이 답이라고 믿어요",
        "ㅋㅋㅋ 이거 완전 제 이야기예요 웃프다",
        "오늘도 좋은 에너지 받고 갑니다 파이팅!",
        "저도 같은 고민이에요 여기 와서 위로받네요",
        "재밌게 읽었어요 ㅎㅎ 다음 글도 기대됩니다",
        "이런 솔직한 글이 더 재밌어요 공감 가는 글 감사합니다",
    ],
    "tip": [
