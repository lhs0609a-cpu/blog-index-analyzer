...
_DOVISION_TAXONOMY = [
    ...
    # ── 대분류 A. 학습솔루션 (B2C 본선, 2026-09-16) ──────────────────
    # 왜 새로 만드나: dovision.co.kr 이 실제로 파는 것은 **이미지전환기억법 ·
    # 특수인지능력검사 · 공부방법**이고 대상은 초·중·고다. 기존 교육 중분류는
    # 사고력수학·코딩·가베 위주라 '파는 것'과 '산 키워드'가 어긋나 있었다.
    # 교육 중분류보다 먼저 둬야 '유아기억력'이 유아가 아니라 기억법으로 간다.
    ("edu_memory", "학습솔루션", "기억법·암기법", [
        ("암기법", ("암기법", "암기잘", "외우는법", "외우기", "빨리외", "잘외우",
                  "영단어암기", "영어단어암기", "한국사암기", "한자암기", "연대표암기")),
        ("기억력훈련", ("기억력", "기억술", "기억훈련", "기억잘", "기억을못", "까먹",
                    "장기기억", "단기기억", "작업기억", "망각곡선", "에빙하우스")),
        ("연상·이미지기억", ("연상암기", "이미지기억", "이미지전환", "스토리텔링암기",
                       "마인드맵", "기억의궁전", "로키법")),
        ("속독", ("속독", "속독법", "빨리읽", "읽기속도")),
    ]),
    ("edu_study", "학습솔루션", "공부법·학습법", [
        ("공부법", ("공부잘하는법", "공부법", "공부방법", "공부하는법", "효율적인공부",
                  "학습법", "학습방법", "혼공", "혼자공부")),
        ("메타인지·인출", ("메타인지", "인출연습", "복습방법", "예습방법", "반복학습",
                      "분산학습", "간격반복")),
        ("시험공부", ("시험공부", "내신공부", "중간고사공부", "기말고사공부", "수행평가준비",
                   "시험기간", "벼락치기")),
        ("노트·정리", ("노트필기", "코넬노트", "오답노트", "요약정리", "필기법")),
        ("계획·습관", ("공부계획", "플래너", "공부습관", "공부시간", "시간관리",
                    "자기주도학습", "공부코칭", "공부자극")),
    ]),
    ("edu_focus", "학습솔루션", "집중력·주의력", [
        ("집중력", ("집중력", "집중못", "집중이안", "집중안되", "집중하는법")),
        ("산만·주의력", ("산만", "주의력", "주의집중", "가만히못", "딴짓", "책상에못앉")),
        ("두뇌훈련", ("두뇌훈련", "뇌훈련", "브레인트레이닝", "인지훈련", "뉴로피드백",
                   "뇌파훈련", "두뇌개발", "두뇌계발", "전뇌", "우뇌")),
    ]),
    ("edu_clinic", "학습솔루션", "학습클리닉·검사", [
        ("학습클리닉", ("학습클리닉", "학습센터", "학습코칭", "학습컨설팅", "학습상담",
                    "공부상담", "공부방법학원", "학습매니지", "학습심리")),
        ("인지·지능검사", ("인지능력검사", "특수인지", "지능검사", "아이큐검사", "웩슬러",
                      "풀배터리", "종합심리검사", "다중지능", "학습유형검사", "학습성향",
                      "적성검사", "기질검사", "영재판별")),
        ("뇌기능검사", ("뇌기능검사", "뇌파검사", "두뇌검사", "뇌검사")),
        ("학습진단", ("학습능력검사", "학습진단", "학습검사", "기초학력진단", "주의력검사")),
    ]),
    ("edu_slow", "학습솔루션", "난독·느린학습자", [
        ("난독·읽기", ("난독", "읽기장애", "쓰기장애", "난산", "읽기부진", "받아쓰기못")),
        ("경계선지능", ("경계선지능", "경계성지능", "느린학습자", "경계선지적", "지적경계")),
        ("ADHD·주의력결핍", ("adhd", "주의력결핍", "과잉행동")),
        ("학습장애·부진", ("학습장애", "학습부진", "기초학력부진", "머리나쁜", "이해력부족")),
    ]),
    ("edu_pain", "학습솔루션", "성적·학습고민", [
        ("성적고민", ("성적이안", "성적안오", "공부해도", "아무리공부", "성적하락",
                   "성적올리", "성적때문")),
        ("공부거부", ("공부안하", "공부못하", "공부싫", "책상에안", "학습의욕", "동기부여")),
        ("문해력·어휘", ("문해력", "어휘력", "독해력", "이해력", "읽고이해")),
    ]),
    ("edu_infant", "교육", "유아", [
